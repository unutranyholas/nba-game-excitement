  ...
  return (
    <InfoChartsContainer>
      {boringGame && <div>
        ...
        <p>{formatTime(parseUrlTime(boringGame.date))}. Feb&nbsp;07, 2018. Spurs took the lead in&nbsp;the first quarter
      ...
      {excitingGame && <div>
        ...
        <p>{formatTime(parseUrlTime(excitingGame.date))}. Jan&nbsp;29, 2017. Knicks and Hawks needed 4&nbsp;exhausting
