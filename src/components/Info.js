  ...
  render() {
    ...
    return <ContentContainer>
      ...
      <p>
        ...
        quarter. Definitely, you won't miss the seventh game between Golden State and Houston in any case, but choosing
      ...
      <p>In early September I came back to the idea of creating my little personal FiveThirtyEight. I did severe
        ...
        (well, I just googled "NBA game excitement"), and <a
          href="https://sports.sites.yale.edu/game-excitement-index-part-ii">found the formula</a> that describes what I
        need pretty
        well.
      </p>
      <FormulaWrapper>
